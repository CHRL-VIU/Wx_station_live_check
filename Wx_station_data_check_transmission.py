...
wx_stations = [x for x in wx_stations if not "legacy_ontree" in x and not "russellmain" in x and not "machmell" in x and not "mountmaya" in x and not "eastbuxton_archive" in x]
